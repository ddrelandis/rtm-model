...
def plot_main_results(temp_true, temp_recon, breast_mask, tumor_center=None,
    ...
    temp_display = temp_true.copy(); temp_display[~breast_mask] = np.nan
    ...
    temp_recon_display = temp_recon.copy(); temp_recon_display[~breast_mask] = np.nan
    ...
    diff = np.abs(temp_true - temp_recon); diff[~breast_mask] = np.nan
    ...
    plt.tight_layout(); plt.savefig('01_main_results.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_tissue_composition(tissue_type_map, breast_mask, areola_mask, nipple_mask, body_mask, birads_category):
    ...
    plt.tight_layout(); plt.savefig('07_tissue_composition.png', dpi=150, bbox_inches='tight'); plt.show()

def plot_breast_anatomy(eps_map, breast_mask, areola_mask, nipple_mask, body_mask):
    fig, axes = plt.subplots(1, 2, figsize=(14, 5))
    eps_display = eps_map.copy(); eps_display[~breast_mask] = np.nan
    ...
    plt.tight_layout(); plt.savefig('08_breast_anatomy.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_temperature_gradient(temp_map, breast_mask, tumor_center=None):
    ...
    plt.tight_layout(); plt.savefig('09_temperature_gradient.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_temperature_contours(temp_map, breast_mask, tumor_center=None):
    ...
    plt.tight_layout(); plt.savefig('10_temperature_contours.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_temperature_difference_map(temp_map, tissue_type_map, breast_mask):
    ...
    plt.tight_layout(); plt.savefig('11_temperature_difference.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_sensitivity_kernels(model, breast_mask, scan_positions, n_show=5):
    ...
    plt.tight_layout(); plt.savefig('02_sensitivity_kernels.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_measurement_data(Tb_data, Tb_noisy, emissivity_avg, scan_positions):
    ...
    plt.tight_layout(); plt.savefig('03_measurement_data.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_temperature_histogram(temp_true, temp_recon, breast_mask):
    ...
    plt.tight_layout(); plt.savefig('04_temperature_histogram.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_cross_section(temp_true, temp_recon, breast_mask, tumor_center=None):
    ...
    plt.tight_layout(); plt.savefig('05_cross_section.png', dpi=150, bbox_inches='tight'); plt.show()
...
def plot_emissivity_map(eps_map, breast_mask):
    ...
    plt.tight_layout(); plt.savefig('06_emissivity_map.png', dpi=150, bbox_inches='tight'); plt.show()